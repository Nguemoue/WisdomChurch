        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li @class(["nav-item","active"=>Route::is("ssabout")])><a href="{{route("about")}}" class="nav-link">About</a></li>
                    ...
                    @can("admin")
                        <li @class(["nav-item","active"=>Route::is("admin.*")])><a href="{{route("admin.index")}}" class="nav-link">Administration</a></li>          
                    @endcan
                </ul>
            </div>
        </div>
