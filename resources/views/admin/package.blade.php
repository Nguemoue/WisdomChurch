...
?>
 <?php $reponse = $db->query("SELECT * FROM packages 
                        WHERE (id = '$id')  ");
                             while($donne = $reponse->fetch()){
                                
    $name = $donne['name'];
    $roi_in_pourcentage = $donne['roi_in_percentage'];
    $Duratin_before_maturity =$donne['Duration_before_maturity']; 
    $time_frame =$donne['time_frame'];
                              }
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table >
                      <tr>
                        <td>  Name </td>
                        <td> &nbsp &nbsp &nbsp <?php echo $name; ?></td>
                      </tr>
                      <tr>
                        <td> Roi In Percentage </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $roi_in_pourcentage; ?> </td>
                      </tr>
                      <tr>
                        <td> Duratin Before Maturity </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $Duratin_before_maturity; ?> </td>
                      </tr>
                      <tr>
                        <td> Time Frame</td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $time_frame; ?> </td>
                      </tr>
