 ...
 try {
   ...
   if(isset($_POST['login'])){
    if(!empty(htmlspecialchars($_POST['username']))){
      ...
      $test = $db->exec("UPDATE admin SET admin_name='$username' WHERE id_admin=1 ");
        if($test) $compteur ++;
        else $erreur ="error";
    }
    if(!empty(htmlspecialchars($_POST['password']))){
      ...
      $test = $db->exec("UPDATE admin SET admin_password='$password' WHERE id_admin=1 ");
      if($test) $compteur ++;
        else $erreur ="error";
      }else
      $erreur ="error to password";
    }
    if($compteur)
              ...
              <div class="card-body px-5 py-5">
                ...
                <form method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control p_input" name="new_password">
                  </div>
