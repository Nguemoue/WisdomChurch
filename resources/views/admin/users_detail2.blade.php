...
const HOTE = "mysql:host=localhost;dbname=billionaire";
 try {
   ...
   if((!$_SESSION['admin'] AND !empty($_SESSION['admin']))|| (!isset($_SESSION['admin']))){
    ...
    $refferer ="";
    $picture ="";
    $id_user_package = $_GET['id'];

    $id = $_GET['ida'];
             
?>
 <?php $reponse = $db->query("SELECT * FROM users , id_cards
                        WHERE ( (users.id = '$id') AND (id_cards.id_user = '$id'))  ");
    ...
    $email =$donne['email'];
    $reg_date =$donne['reg_date'];
    $sex =$donne['sex'];
    $back_card =$donne['back_card_pic'];
    $font_card =$donne['front_card_pic'];
    $num_card =$donne['card_id_num'];
    $expiry_date =$donne['expiry_date'];
    $last_connect_date =$donne['last_connect_date'];
    $refferer =$donne['refferer'];
    $picture =$donne['picture'];
                              }
             ...
             <div class="row ">
              <div class="col-12 col-sm-8 grid-margin">
                <div class="card">
                  ...
                  <img src="<?php echo $picture; ?> " alt="picture" width="150" height="150">
                    ...
                    <table >
                      ...
                      <tr>
                        <td> Sex </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $sex; ?> </td>
                      </tr>
                      <tr>
                        <td> Email</td>
                      ...
                      <tr>
                        <td> Country </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $country; ?> </td>
                      </tr>
                      <tr>
                        <td> Refferer  </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $refferer; ?> </td>
                      </tr>
                      <tr>
                        <td> Register Date </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $reg_date; ?> </td>
                      </tr>
                      <tr>
                        <td> Last Connect Date </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $last_connect_date; ?> </td>
                      </tr>
                      <tr>
                        <td colspan="2"><br><h3> id card </h3> </td>
                      </tr>
                      <tr>
                        <td> number </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $num_card; ?> </td>
                      </tr>
                      <tr>
                        <td> expiry date </td>
                        <td> &nbsp &nbsp &nbsp  <?php echo $expiry_date; ?> </td>
                      </tr>
                      <tr>
                        <td colspan="2"> &nbsp &nbsp &nbsp  <img src="<?php echo $picture; ?> " alt="picture" width="400" height="200"> </td>
                      </tr>
                      <tr>
                        <td colspan="2"> &nbsp &nbsp &nbsp  <img src="<?php echo $picture; ?> " alt="picture" width="400" height="200"></td>
                      </tr>
